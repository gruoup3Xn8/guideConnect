...
import { LocationsModule } from './module/loacation/loacation.module';
...
import { Location } from './module/loacation/entities/loacation.entity';
...
@Module({
  imports: [
    ...
    TypeOrmModule.forRoot({
      ...
      entities: [Guide, Event, Hotel, Restaurant, Transport, Auth, Location],
      synchronize: true
    }),
    GuideModule, EventsModule, HotelModule, RestaurantsModule, TransportModule, AuthModule, LocationsModule
  ],
  controllers: [],
  providers: [],
})
